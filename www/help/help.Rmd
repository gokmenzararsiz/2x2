...
Agreement: Cohen's Kappa, Observed Agreement, Chance Agreement, Positive Agreement, Negative Agreement, Byrt's Bias Index, Byrt's Prevalence Asymmetry Index, Bias Adjusted Kappa, Prevalence & Bias Adjusted Kappa
...
When the users enter values of 'true pozitive (TP)', 'true negative (TN)', 'false pozitive (FP)' and 'false negative (FN)' and confidence interval (percentage) in cell 4 of the 2x2 table, the program automatically calculates statistical values on the right side of the screen.
